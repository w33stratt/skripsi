...
class analisaTopsis extends Controller
{
    ...
    {
        # code...
        $kriteria = \App\Model\Kriteria::all();
        //Prestasi
    ...
    foreach ($kriteria as $key) {
        ...
        foreach ($kriteria as $key) {
            # code...
            if (($key->gaji > 1) and ($key->gaji <= 8000000)) {
                # code...
                $key->l_gaji = 5;
            }elseif (($key->gaji > 8000000) and ($key->gaji <= 12000000)) {
                # code...
                $key->l_gaji = 4;
            }elseif (($key->gaji > 12000000) and ($key->gaji <= 18000000)) {
                # code...
                $key->l_gaji = 3;
            }
            elseif (($key->gaji > 18000000) and ($key->gaji <= 24000000)) {
                # code...
                $key->l_gaji = 2;
            }
            elseif (($key->gaji > 24000000) and ($key->gaji <= 32000000)) {
                # code...
                $key->l_gaji = 1;
            }
        }
    ...
    {
        # code...
        $kriteria = $this->get_positif_distance();
        $solusi_ideal = $this->get_ideal();
        foreach ($kriteria as $key) {
            # code...
    ...
    {
        # code...
        $kriteria = $this->get_negatif_distance();
        foreach ($kriteria as $key) {
            # code...
    ...
    public function linguistik()
    {
        ...
        return Datatables::of($kriteria)
                ->setRowId(function(Kriteria $kriteria){
                    return $kriteria->id;
                })->editColumn('l_wawancara',function($kriteria){
                    if ($kriteria->l_wawancara == 1 ) {
                        # code...
                        return "sangat rendah";
                    }elseif ($kriteria->l_wawancara == 2) {
                        # code...
                        return "Rendah";
                    }elseif ($kriteria->l_wawancara == 3) {
                        # code...
                        return "Cukup";
                    }elseif ($kriteria->l_wawancara == 4) {
                        # code...
                        return "Baik";
                    }elseif ($kriteria->l_wawancara == 5) {
                        # code...
                        return "Sangat Baik";
                    }
                })->editColumn('l_pengetahuan',function($kriteria){
                    if ($kriteria->l_pengetahuan == 1 ) {
                        # code...
                        return "sangat rendah";
                    }elseif ($kriteria->l_pengetahuan == 2) {
                        # code...
                        return "Rendah";
                    }elseif ($kriteria->l_pengetahuan == 3) {
                        # code...
                        return "Cukup";
                    }elseif ($kriteria->l_pengetahuan == 4) {
                        # code...
                        return "Baik";
                    }elseif ($kriteria->l_pengetahuan == 5) {
                        # code...
                        return "Sangat Baik";
                    }
                })->editColumn('l_testing',function($kriteria){
                    if ($kriteria->l_testing == 1 ) {
                        # code...
                        return "sangat rendah";
                    }elseif ($kriteria->l_testing == 2) {
                        # code...
                        return "Rendah";
                    }elseif ($kriteria->l_testing == 3) {
                        # code...
                        return "Cukup";
                    }elseif ($kriteria->l_testing == 4) {
                        # code...
                        return "Baik";
                    }elseif ($kriteria->l_testing == 5) {
                        # code...
                        return "Sangat Baik";
                    }
                })->editColumn('l_cv',function($kriteria){
                    if ($kriteria->l_cv == 1 ) {
                        # code...
                        return "sangat rendah";
                    }elseif ($kriteria->l_cv == 2) {
                        # code...
                        return "Rendah";
                    }elseif ($kriteria->l_cv == 3) {
                        # code...
                        return "Cukup";
                    }elseif ($kriteria->l_cv == 4) {
                        # code...
                        return "Baik";
                    }elseif ($kriteria->l_cv == 5) {
                        # code...
                        return "Sangat Baik";
                    }
                })->editColumn('l_waktu_pengerjaan',function($kriteria){
                    if ($kriteria->l_waktu_pengerjaan == 3 ) {
                        # code...
                        return "Cukup";
                    }elseif ($kriteria->l_waktu_pengerjaan == 4) {
                        # code...
                        return "Cepat";
                    }elseif ($kriteria->l_waktu_pengerjaan == 5) {
                        # code...
                        return "Sangat Cepat";
                    }elseif ($kriteria->l_waktu_pengerjaan == 1) {
                        # code...
                        return "Sangat Lambat";
                    }elseif ($kriteria->l_waktu_pengerjaan == 2) {
                        # code...
                        return "Lambat";
                    }
                })->editColumn('l_gaji',function($kriteria){
                    if ($kriteria->l_gaji == 3 ) {
                        # code...
                        return "Cukup";
                    }elseif ($kriteria->l_gaji == 4) {
                        # code...
                        return "Rendah";
                    }elseif ($kriteria->l_gaji == 5) {
                        # code...
                        return "Sangat Rendah";
                    }elseif ($kriteria->l_gaji == 2) {
                        # code...
                        return "Tinggi";
                    }elseif ($kriteria->l_gaji == 1) {
                        # code...
    ...
    {
        # code...
        $kriteria2['solusi'] = $this->get_ideal();
        return view('admin.topsis.solusi_ideal',$kriteria2);
    }
    ...
    {
        # code...
        $kriteria = $this->get_nilai_preferensi();
        return Datatables::of($kriteria)
                ->setRowId(function(Kriteria $kriteria){
                    return $kriteria->id;
                })->make(true);
