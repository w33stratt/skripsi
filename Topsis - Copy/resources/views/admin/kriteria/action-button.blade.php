<div class="button-list" data-table-target="table-kriteria">
    ...
    <button data-url="{{route('admin.kriteria.delete')}}" class="btn btn-icon waves-effect waves-light btn-danger" onclick="hapusData(this);"> <i class="fa fa-remove"></i> </button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal form-edit-kriteria" method="POST">
                    @csrf
                    <fieldset id="fieldset">
                        ...
                        <div class="form-group m-b-25">
                            <div class="col-12">
                                ...
                                <input class="form-control" name="wawancara" type="text" id="wawancara" required="" placeholder="Masukan Penilaian"  >
                            </div>
                        </div>
                        <div class="form-group m-b-25">
                            <div class="col-12">
...
<script>
    ...
    $(".modal-edit").click(function(){
        ...
        var id = $(this).data('id');
        var url = "{{ route('admin.kriteria.edit', 'ID') }}";
    ...
    $(".form-edit-kriteria").submit(function(event){
        ...
        $.ajax({
                url:"{{ route('admin.kriteria.update') }}",
                type:'POST',
                data:$(this).serialize(),
