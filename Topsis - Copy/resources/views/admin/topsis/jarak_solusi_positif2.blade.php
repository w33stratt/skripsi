...
<div class="row">
    <div class="col-12">
        <div class="card-box table-responsive">
            <h4 class="m-t-0 header-title"><b>Jarak Solusi Positif Pelamar Pelamar Sistem Transit Barang</b></h4>
...
<script type="text/javascript">
            ...
            $(document).ready(function() {
                $("#table-kriteria2").DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: '{!! route('admin.topsis.jarak_solusi_positif2') !!}',
                    order:[0,'desc'],
                    columns:[
                        {data:'id', name: 'id'},
                        {data:'name', name: 'name'},
                        ...
                        {data:'a_total', render: function(row) {
                            return row.toFixed(5)
                        },name:'a_total'}                        
                    ]
                });
