...
<div class="row">
    <div class="col-12">
        <div class="card-box table-responsive">
            <h4 class="m-t-0 header-title"><b>Matrix Keputusan Ternormalisasi Pelamar Sistem Transit Barang</b></h4>
         ...
         <script type="text/javascript">
            ...
            $(document).ready(function() {
                $("#table-kriteria2").DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: '{!! route('admin.topsis.matrix_keputusan_ternormalisasi2') !!}',
                    order:[0,'desc'],
                    columns:[
                        {data:'id', name: 'id'},
                        {data:'name', name: 'name'},
